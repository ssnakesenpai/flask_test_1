...
- 🎯 Entry points to execute your program using `python -m <flask_test_1>` or `$ flask_test_1` with basic CLI argument parsing.
...
Awesome flask_test_1 created by ssnakesenpai
...
```bash
git clone https://github.com/ssnakesenpai/flask_test_1 flask_test_1
cd flask_test_1
make install
```
